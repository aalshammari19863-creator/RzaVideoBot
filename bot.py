...
# 🔑 التوكن ومعرف المسؤول (تم وضع معرفك مباشرة)
...
async def send_welcome_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        "📥 أرسل رابط الفيديو - صور من TikTok، وسأقوم بمعالجته وإرساله لك بأفضل جودة ممكنة.\n\n"
        "⚡ سريع • سهل • مجاني"
    )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 🚨 التحقق وحظر روابط سناب شات عن العامة والسماح لك فقط
